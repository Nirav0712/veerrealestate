...
export default function EastProjectPage() {
  ...
  const filteredProjects = eastProjects.filter((project) => {
  ...
  return (
    <>
      ...
      {/* Header Section */}
      <div className="bg-linear-to-r from-secondary to-secondary-light text-white py-8 md:py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold mb-2">
            East Projects
          </h1>
          <p className="opacity-90">
            Explore premium projects in East zone
          </p>
        </div>
      </div>
            ...
            <aside className="lg:w-80 shrink-0">
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                ...
                <form className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full cursor-pointer bg-white text-secondary border-2 border-secondary px-6 py-3 rounded-lg font-semibold hover:bg-secondary hover:text-white transition-colors"
                  >
                ...
                {filteredProjects.map((project) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      {/* ✅ IMPORTANT: East Slug */}
                      <Link href={`/projects/east/${project.slug}`}>
                        <button className="w-full cursor-pointer bg-white text-secondary border-2 border-secondary py-2 rounded-lg hover:bg-secondary hover-text-white hover:text-white transition-colors">
                          SEE DETAILS
                        </button>
                      </Link>
