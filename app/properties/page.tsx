...
function PropertiesContent() {
    ...
    return (
        <>
            ...
            {/* Page Header */}
            <div className="bg-linear-to-br from-secondary to-secondary-light text-white py-8 md:py-16">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full cursor-pointer px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
                                    >
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <input
                                            ...
                                            onChange={handleFilterChange}
                                            placeholder="Min"
                                            className="px-4 cursor-pointer py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
                                        />
                                        <input
                                            type="number"
                                            name="maxPrice"
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={handleFilterChange}
                                        className="w-full px-4 py-3 border cursor-pointer border-gray-300 rounded-lg focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
                                    >
                                        <option value="all">All</option>
                                ...
                                <button
                                    type="submit"
                                    className="w-full cursor-pointer bg-white border border-secondary text-secondary px-6 py-3 rounded-lg font-semibold hover:bg-secondary hover:text-white transition-colors"
                                >
                    ...
                    <div className="flex-1">
                        ...
                        {loading ? (
                            ...
                            <div className="text-center py-10 md:py-20">
                                ...
                                <button
                                    onClick={clearFilters}
                                    className="bg-primary cursor-pointer text-white px-8 py-3 rounded-lg font-semibold hover:bg-primary-dark transition-colors"
                                >
                                    Clear Filters
                                </button>
                            </div>
