...
export default function PropertyDetailsPage() {
    ...
    if (!property) {
        return <div className='flex justify-center items-center py-10 md:py-20'><Loader /></div>;
    }
            ...
            <div className="py-6 md:py-12">
                <div className="container mx-auto px-4">
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-600 mb-8">
                        ...
                        <a href="/properties" className="hover:text-primary cursor-pointer">Properties</a>
                        <i className="fas fa-chevron-right text-xs"></i>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="relative rounded-2xl overflow-hidden mb-4 bg-black" style={{ height: '420px' }}>
                                ...
                                {images.map((src, index) => (
                                    ...
                                    >
                                        <img
                                            ...
                                            className="object-cover w-full h-full no-repeat overflow-hidden"
                                        // priority={index === 0}
                                        />
                                    </div>
                                ))}
                                ...
                                <button
                                    ...
                                    className={`absolute top-5 right-5 w-12 h-12 rounded-full flex items-center justify-center transition-all shadow-lg z-20 cursor-pointer ${isFavorite
                                ...
                                {images.length > 1 && (
                                    <>
                                        <button
                                            onClick={handlePrev}
                                            className="absolute left-4 top-1/2 -translate-y-1/2 z-20 w-10 h-10 bg-white/80 hover:bg-white rounded-full flex items-center justify-center shadow-lg transition-all hover:scale-110 cursor-pointer"
                                        ...
                                        <button
                                            onClick={handleNext}
                                            className="absolute right-4 top-1/2 -translate-y-1/2 z-20 w-10 h-10 bg-white/80 hover:bg-white rounded-full flex items-center justify-center shadow-lg transition-all hover:scale-110 cursor-pointer"
                                ...
                                <div className="flex gap-2 mb-8 overflow-x-auto pb-1">
                                    {images.map((src, index) => (
                                        <button
                                            key={index}
                                            onClick={() => handleDotClick(index)}
                                            className={`relative shrink-0 w-20 h-16 rounded-lg overflow-hidden transition-all duration-200 cursor-pointer ${index === currentImageIndex
                        ...
                        <div className="lg:col-span-1">
                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-6 mb-6 sticky top-24">
                                ...
                                <form className="space-y-4">
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full cursor-pointer bg-primary text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary-dark transition-colors"
                                    >
                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-6">
                                ...
                                <div className="flex gap-3">
                                    <button onClick={() => window.open(`https://www.facebook.com/people/Veer-Real-Estate/61558935522154/`, '_blank')} className="flex-1 cursor-pointer bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 transition-colors">
                                        <i className="fab fa-facebook-f"></i>
                                    </button>
                                    <button onClick={() => window.open(`https://www.youtube.com/@VeerRealEstate`, '_blank')} className="flex-1 cursor-pointer bg-red-600 text-white py-3 rounded-lg hover:bg-red-700 transition-colors">
                                        <i className="fab fa-youtube"></i>
                                    </button>
                                    <button onClick={() => window.open(`https://www.instagram.com/veer.real_estate/`, '_blank')} className="flex-1 cursor-pointer bg-pink-600 text-white py-3 rounded-lg hover:bg-pink-700 transition-colors">
                                        <i className="fab fa-instagram"></i>
                                    </button>
                                    <button onClick={() => window.open(`https://g.page/r/CcSCOVV14JRdEAI/review`, '_blank')} className="flex-1 cursor-pointer bg-gray-600 text-white py-3 rounded-lg hover:bg-gray-700 transition-colors">
