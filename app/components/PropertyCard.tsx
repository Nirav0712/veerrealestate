            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group">
                ...
                <div className="relative h-64 overflow-hidden">
                    <img
                        ...
                        alt={property.title}
                        className="object-cover group-hover:scale-110 transition-transform duration-500 object-center w-full h-full no-repeat overflow-hidden"
                    />
                    ...
                    <button
                        ...
                        className={`absolute top-4 right-4 w-10 h-10 rounded-full flex items-center justify-center transition-all shadow-md cursor-pointer ${isFavorite
