...
export default function HomePage() {
  ...
  const handleSearch = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (formData.get('type') !== 'all') params.set('type', formData.get('type') as string);
    if (formData.get('bedrooms') !== 'all') params.set('bedrooms', formData.get('bedrooms') as string);
            ...
            <div className="backdrop-blur-lg bg-white/20 rounded-xl p-6 shadow-2xl border border-white/30">
              ...
              <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                >
                  ...
                  <option value="House">House</option>the hero section is the auto scroll to set the diffrent images and the search box is the set in the bg to glass efect in the bg
